...
class CellDetector:
    ...
    def crop_row(self, image, row_y1, row_y2):
        ...
        plt.imshow(cv2.cvtColor(cropped_row, cv2.COLOR_BGR2RGB))
        plt.title("Cropped Row")
        plt.show()
    ...
    def crop_column(self, image, col_x1, col_x2):
        ...
        plt.imshow(cv2.cvtColor(cropped_column, cv2.COLOR_BGR2RGB))
    ...
    def crop_cell(self, image, row_y1, row_y2, col_x1, col_x2, show=False):
        ...
        if show:
            plt.imshow(cv2.cvtColor(cropped_cell, cv2.COLOR_BGR2RGB))
