...
class Element:
    def __init__(self, id, corner, category, text_content=None):
        ...
        self.context = []  # Context of neighboring elements
        self.privacy_type = None  # Info why element is private
        self.substitution = None  # What to replace the value with
        self.cell = None  # Cell of a table
    ...
    # inter: absolute area, iou: relative area of both elements, ioa: relative area of self that is intersecting, iob: relative area of element_b
    ...
    def visualize_element(self, img, color=(0, 255, 0), line=1, text="[]", show=False):
        ...
        img = cv2.putText(
            img, text, (x_1, y_1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (36, 255, 12), 1
        )
        if show:
